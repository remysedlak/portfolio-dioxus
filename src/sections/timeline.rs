...
pub const TIMELINE: &[TimeLineItem] = &[
    ...
    TimeLineItem {
        ...
        title: "CS @ Pitt",
        duration: "4 years",
        details: "Began my persuit of a <b>B.S. in Computer Science</b> and <b>Digital Narrative and Interactive Design</b> at the <a class=\"text-blue-500 hover:underline\" target=\"_blank\" href=\"https://www.pitt.edu/\">University of Pittsburgh</a>, with a focus on the intersection of <b>technology</b> and human behavior. Applying <b>interdisciplinary knowledge</b> to real-world projects in AI, UX design, and music technology.",
    },
    TimeLineItem {
        year: "2022",
        title: "Warehousing",
        duration: "2 years",
        details: "Worked as a <b>warehouse associate</b> at <a class=\"text-blue-500 hover:underline\" target=\"_blank\" href=\"https://www.fayettepartsservice.com/\">Fayette Service Parts Inc.</a>, managing <b>inventory</b> for over 25+ NAPA automotive stores. Gained experience in <b>logistics</b>, supply chain operations, and data tracking, ensuring accurate inventory management in a high-demand environment. Developed strong <b>problem-solving skills</b> by troubleshooting logistical challenges and optimizing warehouse efficiency.",
    },
    TimeLineItem {
        year: "2021",
        title: "Hello World!",
        duration: "9 months",
        details: "Took my first <b>programming course</b> through a <a class=\"text-blue-500 hover:underline\" target=\"_blank\" href=\"https://www.chs.pitt.edu/\">College in High School (CHS)</a> program, sparking my passion for <b>software development</b>. Started with <b>fundamental programming concepts</b> and quickly became fascinated with problem-solving, leading to deeper explorations in AI, full-stack development, and data science. This moment marked the <b>foundation</b> of my journey into technology, setting the stage for future projects and innovations.",
    },
];
